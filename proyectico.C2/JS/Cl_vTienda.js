...
export default class Cl_vTienda{
    constructor(){
        ...
        this.mvideo = null;
        this.tablaFotografia = document.getElementById(
            "IndexForm_tablaPromocion");
        this.tablaVideo = document.getElementById(
            "IndexForm_tablaVideo");
        this.lbltotalVendido=document.getElementById(
            "IndexForm_lbltotalVendido");
        ...
        this.vFotografia.btProcesar.onclick = () => this.controlador. procesarFotografia();
    ...
    reportarFotografia(totalVendido,contadorDeFotosDigitales,
        subTotalFotosDigitales,promedioFotosDigitales){
            this.tablaFotografia.innerHTML +=`<tr>
            <td>${this.mFotografia.codigo}</td>
            <td>${this.mFotografia.costo.toFixed(2)}</td>
        ...
        FotografiaForm.hidden = true;
        FotografiaForm.hidden =false;
       
    }
    reportarVideo(totalVendido,contadorDeFotosDigitales,
        subTotalFotosDigitales, promedioFotosDigitales){
